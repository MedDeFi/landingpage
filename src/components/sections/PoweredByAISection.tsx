...
export const PoweredByAISection = () => (
  <AnimatedSection className="py-10 sm:py-20 -mt-8 sm:-mt-12 px-2 sm:px-6 bg-gray-50 shadow-xl mb-8 sm:mb-16 mt-8 sm:mt-16 mr-2 sm:mr-4 ml-2 sm:ml-4 backdrop-blur-2xl rounded-3xl text-center">
    ...
    <h2 className="text-2xl sm:text-4xl font-bold text-gray-900">Powered by Intelligence</h2>
