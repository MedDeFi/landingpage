/**
 * Next.js loading.tsx - Used for route transitions and Suspense boundaries
 * This is a server component that displays during route transitions
 * Note: Cannot import client components, so we implement the logo inline
 */
export default function RouteLoading() {
  // For route transitions, we show a simplified version
  // The full Loading component with animations works better for initial page loads
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-t from-blue-600 to-blue-500">
      <div className="flex flex-col items-center">
        <div className="relative">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-64 h-40 rounded-full bg-white/5 blur-3xl animate-pulse" />
          </div>
          <div className="relative animate-pulse">
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              viewBox="0 0 399.17 80.13" 
