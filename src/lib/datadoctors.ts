export const featuresDoctorsData = [
    { 
        icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m12.728 0l-.707.707M12 21v-1m-6.364-1.636l.707-.707m12.728 0l.707-.707", 
        title: 'Reach More', 
        description: 'Grow your practice by connecting with patients from around the world.' 
    },
    { 
        icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", 
        title: 'Get Verified', 
        description: 'Let your patients know you are a trusted medical professional.' 
    },
    { 
        icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", 
        title: '24/7 Virtual Access', 
        description: 'Connect with real patients and provide consultations anytime, from anywhere.' 
    },
];

// Individual feature exports for flexibility
export const featuresDoctors1Data = [featuresDoctorsData[0]];
export const featuresDoctors2Data = [featuresDoctorsData[1]];
export const featuresDoctors3Data = [featuresDoctorsData[2]];

export const testimonialsDoctorsData = [
