  ...
  ({ onClaimSpot }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className='flex flex-col absolute bg-gray-500/40 lg:bg-white/0  backdrop-blur-sm md:left-12 lg:left-28 items-center md:items-start justify-center rounded-3xl p-16 mx-4 py-16 md:p-4 lg:py-20 lg:px-4 md:w-2/5'>
          ...
          <button 
            onClick={onClaimSpot} 
            className="cta-button bg-blue-600 text-white items-center justify-center font-semibold py-4 px-16 lg:px-20 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-100 transition-all duration-300">
              Claim Your Spot
          </button>
