...
export default function Loading({ onLoadingComplete, criticalImages = [] }: LoadingProps) {
  ...
  useEffect(() => {
    if (isReady && onLoadingComplete) {
      ...
      setTimeout(() => {
        ...
        // Wait for fade-out transition (1000ms) to complete before calling onLoadingComplete
        setTimeout(() => {
          onLoadingComplete();
        }, 1000);
      }, remainingTime);
  ...
  return (
    <div 
      className={`fixed inset-0 z-50 bg-gradient-to-t from-blue-600 to-blue-500 flex items-center justify-center transition-opacity duration-1000 ease-in-out ${
