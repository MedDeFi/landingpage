...
export const FeatureSectionDoctor = () => (
  <AnimatedSection className="flex flex-col items-center justify-center relative pt-28 pb-20 px-6 bg-gray-100 shadow-xl backdrop-blur-2xl sm:rounded-3xl md:rounded-3xl sm:-mt-16 md:mt-16 md:mx-4 z-40"> 
