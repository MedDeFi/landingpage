      ...
      <div className="flex justify-center items-center bg-black min-h-screen">
        <div className="w-full max-w-sm h-[844px] max-h-[844px] bg-gray-50 rounded-[44px] shadow-2xl overflow-hidden relative border-8 border-black">
          ...
          <div className="h-full overflow-y-auto bg-gray-200 main-content relative">
              {/* --- HERO SECTION --- */}
              <header className={`flex justify-between items-center transition-all duration-700 ease-in-out relative z-40 bg-gray-200/80 backdrop-blur-sm px-4 ${isModalOpen ? 'animate-blur-in' : 'animate-blur-out'}`}>
                <Navbar />
              </header>
